# analysis.py — Neuromodulation and Emerging Neurotechnologies: TMS, tDCS, DBS and Brain-Computer Interfaces Database
...
print(f"Dataset: Neuromodulation and Emerging Neurotechnologies: TM")
print(f"DOI: 10.5281/zenodo.18881112")
...
fig.suptitle("Neuromodulation and Emerging Neurotechnologies: TMS, tDCS, D", fontsize=11, fontweight="bold")
...
print(f"""
Citation:
de la Serna Tuya, Juan Moisés (2026). Neuromodulation and Emerging Neurotechnologies: TMS, tDCS, DBS and Bra. Zenodo. https://doi.org/10.5281/zenodo.18881112
""")
